...
const listarServicosController = {};

listarServicosController.calcPrecoPrazo = async (req, res) => {
    ...
    const response = await makeRequest('http://ws.correios.com.br/calculador/CalcPrecoPrazo.asmx/ListaServicos', 'POST', obj);

    res.json(response);

};

module.exports = listarServicosController;
